...
<script>
        ...
        function refresh(page,pageSize){
          ...
          $.post("/Blog/article/list",{
            ...
            //设置当前文章总数量
            $("#count").text("共计" + data.total + "篇文章");

            //每次先清空上次内容
            $("#articleBody").html("");
            //data : PageInfo<article>
            ...
            for (var i = 0; i < articles.length; i++){
              ...
              if(article.isOpen == "0"){
                ...
                $("#articleBody").append("<tr>\n" +
                        ...
                        "                    <input type=\"radio\" onclick=change(\'"+article.aid+"\',$(this).val()) name="+article.aid+" value=\"1\" />公开 <input type=\"radio\" onclick=change(\'"+article.aid+"\',$(this).val()) name="+article.aid+" checked value=\"0\" />私密\n" +
                        "                </td>\n" +
                        "              </tr>");
              }else {
                //文章公开，公开按钮选中
                $("#articleBody").append("<tr>\n" +
                        ...
                        "                <td>\n" +
                        "                    <a href=\"/Blog/toView/workbench/article/updateArticle?id="+article.aid+"\">修改</a> <a onclick=\"deleteById('"+article.aid+"')\" href='javascript:void(0)'>删除</a>&nbsp;\n" +
                        "                    <input type=\"radio\" onclick=change(\'"+article.aid+"\',$(this).val()) name="+article.aid+" value=\"1\" checked/>公开 <input type=\"radio\" onclick=change(\'"+article.aid+"\',$(this).val()) name="+article.aid+" value=\"0\" />私密\n" +
                        "                </td>\n" +
                        "              </tr>");
