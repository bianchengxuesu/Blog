    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      ...
      <div class="table-responsive">
        <table class="table table-striped table-hover">
          <tbody>
            <tr>
              <td>登录者: <span>${sessionScope.user.nickname}</span>，这是您第 <span>${sessionScope.user.loginCout}</span> 次登录</td>
            </tr>
            <tr>
        ...
        <div class="modal-body">
          <table class="table" style="margin-bottom:0px;">
            ...
            <tbody>
              ...
              <tr>
                <td wdith="20%">新密码:</td>
                <td width="80%"><input type="password" id="firstPwd" class="form-control" name="password" maxlength="18" autocomplete="off" /></td>
              </tr>
              <tr>
                <td wdith="20%">确认密码:</td>
                <td width="80%"><input type="password" id="secondPwd" class="form-control" name="new_password" maxlength="18" autocomplete="off" /></td>
              </tr>
            </tbody>
            <tfoot>
              <tr></tr>
...
<script>
    ...
    $('#oldPwd').blur(function () {
        ...
        $.post("/Blog/user/verifyOldPwd",{'oldPwd':$(this).val()},function (data) {
            if(!data.ok){
                layer.msg(data.mess, {offset:'20px'});
            }
        },'json');
    ...
    $('#secondPwd').blur(function () {
       ...
       if (val1 != val2){
         layer.msg("两次输入的密码不一致!", {offset:'20px'});
       }
    });
</script>